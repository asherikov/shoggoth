...
stop: tunnel_up
	...
	-${K3S_KUBECTL} delete deployment,statefulset,daemonset,job,svc ${SERVICE} -n shoggoth --ignore-not-found=true
...
log: tunnel_up
	...
	@echo ""
	@echo "--- Status ---"
	@KUBECONFIG=${K3S_KUBECONFIG} kubectl -n shoggoth get pod -l app=$(SERVICE) -o wide 2>&1 || true
	@echo ""
